...
define i32 @main() {
  ...
  %reg1 = call ptr @read_line()
  %reg2 = call ptr @reverse_string(ptr %reg1)
  %reg3 = call ptr @concat_strings(ptr @lit3, ptr %reg2)
  call i32 @puts(ptr %reg3)
  call i32 @puts(ptr @lit4)
  call i32 @puts(ptr @lit5)
  %reg4 = and i1 false, false
  %reg5 = alloca i1
  store i1 %reg4, ptr %reg5
  %reg6 = load i1, ptr %reg5
  call void @print_bool(i1 %reg6)
  %reg7 = or i1 true, true
  store i1 %reg7, ptr %reg5
  %reg8 = load i1, ptr %reg5
  call void @print_bool(i1 %reg8)
  %reg9 = alloca ptr
  %reg10 = getelementptr inbounds [6 x i8], ptr @lit6, i64 0, i64 0
  store ptr @lit6, ptr %reg9
  %reg11 = load ptr, ptr %reg9
  call i32 @puts(ptr %reg11)
  store ptr @lit7, ptr %reg9
  %reg13 = load ptr, ptr %reg9
  call i32 @puts(ptr %reg13)
  br label %block1
block1:
  %reg14 = or i1 true, true
  br i1 %reg14, label %block2, label %block3
block2:
...
block4:
  br label %block5
block5:
  %reg15 = and i1 false, false
  br i1 %reg15, label %block6, label %block7
block6:
...
block8:
  %reg16 = alloca ptr
  %reg17 = getelementptr inbounds [7 x i8], ptr @lit11, i64 0, i64 0
  store ptr @lit11, ptr %reg16
  br label %block9
block9:
  %reg18 = load ptr, ptr %reg16
  %reg19 = call i1 @string_contains(ptr %reg18, ptr @lit12)
  %reg20 = xor i1 %reg19, true
  br i1 %reg20, label %block10, label %block11
block10:
  call i32 @puts(ptr @lit13)
  %reg21 = load ptr, ptr %reg16
  %reg22 = call ptr @concat_strings(ptr %reg21, ptr @lit14)
  store ptr %reg22, ptr %reg16
  br label %block9
block11:
  ret i32 0
}
@lit1 = constant [34 x i8] c"Testing pre-modification function\00"
@lit2 = constant [24 x i8] c"Hello\0AEnter something! \00"
@lit3 = constant [15 x i8] c"Look at this! \00"
@lit4 = constant [2 x i8] c"\0A\00"
@lit5 = constant [18 x i8] c"Testing variables\00"
@lit6 = constant [6 x i8] c"test1\00"
@lit7 = constant [6 x i8] c"test2\00"
@lit8 = constant [9 x i8] c"if block\00"
@lit9 = constant [4 x i8] c"BAD\00"
@lit10 = constant [11 x i8] c"else block\00"
@lit11 = constant [1 x i8] c"\00"
@lit12 = constant [4 x i8] c"...\00"
@lit13 = constant [4 x i8] c"cha\00"
@lit14 = constant [2 x i8] c".\00"
